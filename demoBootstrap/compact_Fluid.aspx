<%@ Page Title="" Language="C#" MasterPageFile="~/protocol.master" AutoEventWireup="true" CodeFile="compact_Fluid.aspx.cs" Inherits="compact_Fluid" %>
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><asp:Button ID="Button2" runat="server" Text="Localized RadioGraph" CssClass="btn btn-primary btn-xs btn-block" OnClick="Button2_Click"/></li>
                <li class="active"><asp:Button ID="Button3" runat="server" Text="Rotational Scan" CssClass="btn btn-primary btn-xs btn-block" OnClick="Button3_Click"/></li>
                <li class="active"><asp:Button ID="Button4" runat="server" Text="Reconstruction" CssClass="btn btn-primary btn-xs btn-block" OnClick="Button4_Click"/></li>       
            </ul>
            </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><asp:Button ID="Button8" runat="server" Text="Scan Tab" CssClass="btn btn-primary btn-xs btn-block" OnClick="Button8_Click" /></li>
                <li class="active"><asp:Button ID="Button9" runat="server" Text="Recon Tab" CssClass="btn btn-primary btn-xs btn-block" OnClick="Button9_Click" /></li>
                <li class="active"><asp:Button ID="Button10" runat="server" Text="Bolus Tracking" CssClass="btn btn-primary btn-xs btn-block" OnClick="Button10_Click" /></li>       
            </ul>
            </div>
            </div>
        </div>
