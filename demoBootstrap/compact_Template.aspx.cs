...
public partial class compact_Template : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            Button1.CssClass = "btn btn-primary btn-md active btn-block";
            MultiViewMain.ActiveViewIndex = 0;
            MultiView_btn1.ActiveViewIndex = 0;

            Button7.CssClass = "btn btn-primary btn-md active btn-block";
    ...
    {
        Button1.CssClass = "btn btn-primary active btn-md btn-block";
        Button2.CssClass = "btn btn-primary btn-sm btn-block";
        Button3.CssClass = "btn btn-primary btn-sm btn-block";
        Button4.CssClass = "btn btn-primary btn-sm btn-block";
        MultiViewMain.ActiveViewIndex = 0;
        MultiView_btn1.ActiveViewIndex = 0;
    }
    ...
    {
        Button1.CssClass = "btn btn-primary btn-sm btn-block";
        Button2.CssClass = "btn btn-primary active btn-md btn-block";
        Button3.CssClass = "btn btn-primary btn-sm btn-block";
        Button4.CssClass = "btn btn-primary btn-sm btn-block";
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        Button1.CssClass = "btn btn-primary btn-sm btn-block";
        Button2.CssClass = "btn btn-primary btn-sm btn-block";
        Button3.CssClass = "btn btn-primary active btn-md btn-block";
        Button4.CssClass = "btn btn-primary btn-sm btn-block";
    ...
    { 
        ...
        Button2.CssClass = "btn btn-primary btn-sm btn-block";
        Button3.CssClass = "btn btn-primary btn-sm btn-block";
        Button4.CssClass = "btn btn-primary active btn-md btn-block";
