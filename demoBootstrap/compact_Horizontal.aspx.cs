...
public partial class compact_Horizontal : System.Web.UI.Page
{
    ...
    {
        Button1.CssClass = "btn btn-primary active btn-xs btn-block";
        Button2.CssClass = "btn btn-default btn-xs btn-block";
        Button3.CssClass = "btn btn-default btn-xs btn-block";
        Button4.CssClass = "btn btn-default btn-xs btn-block";
        MultiViewMain.ActiveViewIndex = 0;
        MultiView_btn1.ActiveViewIndex = 0;
    }
    ...
    {
        Button1.CssClass = "btn btn-default btn-xs  btn-block";
